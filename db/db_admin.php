...
try {
    ...
    if (!file_exists($init_file_path)) {
        ...
        $db->exec("
            ...
            ('admin', 'admin', 'admin123', '관리자 계정', TRUE),
            ('user1', 'user1', 'password1', '일반 사용자', FALSE)
        ");
        ...
        $db->exec("
            ...
            (2, '[관리자 전용] 점심 메뉴 투표', '이 글을 보고 계신다면... 축하합니다! SQL 인젝션 공격에 성공하셨군요. 저희의 허술한 방어벽을 뚫으셨네요.다음 단계로 넘어가기 위한 정답은 점심은제육볶음 입니다. (P.S. 운영팀에게 이 사실을 알리지 말아 주세요.)', 1),
            ...
            (6, '[관리자 전용] 야식 메뉴 투표', '아 배고픈데 진짜 저녁 뭐먹을래 만들다 밤을 몇번을 샌거야....', 1),
            (7, '공지사항', '하나 하나 구현 한다고 연휴도 반납한 개발자에게 X 를눌러 조의를 표해주세요', 0),
